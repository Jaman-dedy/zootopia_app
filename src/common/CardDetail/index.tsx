...
const CardDetail = () => {
    return (
        <div className="h-[460px] w-[850px] py-5 px-6 shadow-lg rounded-md">
        <div className="text-lg font-semibold mb-3">High rating</div>
        <div className="flex mb-6">
            <img src={PaonImg} alt="" className="h-[300px] w-[300px] mr-5 mt-6" />
            <div>
                <div className="mb-2">
                    <div className="text-md font-semibold">Congoleese Paon</div>
                    <div className="text-sm italic w-[200px]">
                        ...
                        <div>
                            <dl>
                                ...
                                <dd className="flex items-center mb-2">
                                    <div className="w-full bg-gray-200 rounded h-1.5 dark:bg-gray-700 mr-2">
                                        <div className="bg-blue-600 h-1.5 rounded dark:bg-blue-500" style={{ width: "88%" }}></div>
                                    </div>
                            ...
                            <dl>
                                ...
                                <dd className="flex items-center mb-2">
                                    <div className="w-full bg-gray-200 rounded h-1.5 dark:bg-gray-700 mr-2">
                                        <div className="bg-blue-600 h-1.5 rounded dark:bg-blue-500" style={{ width: "89%" }}></div>
                                    </div>
                            ...
                            <dl>
                                ...
                                <dd className="flex items-center">
                                    <div className="w-full bg-gray-200 rounded h-1.5 dark:bg-gray-700 mr-2">
                                        <div className="bg-blue-600 h-1.5 rounded dark:bg-blue-500" style={{ width: "54%" }}></div>
                                    </div>
