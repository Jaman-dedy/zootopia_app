        ...
        <div className="mt-10 mr-7">
            <div className="h-[440px] w-[310px] relative">
              ...
              <div className="absolute bottom-0 px-4 py-6 bg-slate-950/50 w-full">
                ...
                <div className="text-slate-200">24M Species</div>
              </div>
            </div>
            <div className="w-[310px] px-1 py-1  border-width border-black border-solid">
              <div className="text-sm">
                My name is dudu, I am from  srilanka,
              we are 200 M of my species in all the wolrd I like humans, can you rate for me please.
              </div>
              ...
              <div className="flex items-center ">
                ...
                <p className="ml-2 text-sm font-medium text-gray-500 dark:text-gray-400">5k Reviews</p>
              </div>
